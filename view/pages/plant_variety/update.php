<?php
    ...
    require_once('../../../controller/PlantVarietyController.php');
?>
<div>
      ...
      <h1>Create Variety</h1>
        <form method="POST" action="">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?php echo $getSpecificType['variety_name']?>" name="variety_name" id="variety_name" placeholder="ex. Type 1" required>
            </div>
            <div class="form-group">
