...
class NurseryOwner extends config {
    ...
    public function getNurseryOwners() {
        try {
            $query = "SELECT `id`, `nurser_owner_id`, `fullname`, `contact_number`, `address`, `created_date` FROM `nursery_owner_tbl` WHERE 1";
    ...
    public function create($fullname, $contact_number, $address) {
        try {
            ...
            $query = "INSERT INTO `nursery_owner_tbl` (`nurser_owner_id`, `fullname`, `contact_number`, `address`, `created_date`) 
    ...
    public function getNurseryOwnerById($id) {
        try {
                $query = "SELECT `id`, `nurser_owner_id`, `fullname`, `contact_number`, `address`, `created_date` FROM `nursery_owner_tbl` WHERE `id` = :id";
                $stmt = $this->pdo->prepare($query); // Prepare the query
    ...
    public function update($id, $fullname, $contact_number, $address) {
        try {
            ...
            $query = "UPDATE `nursery_owner_tbl` 
                      SET `fullname` = :fullname, `contact_number` = :contact_number, `address` = :address
                      WHERE `id` = :id";
    ...
    public function delete($id) {
        try {
            $query = "DELETE FROM `nursery_owner_tbl` WHERE `id` = :id";
            $stmt = $this->pdo->prepare($query);
